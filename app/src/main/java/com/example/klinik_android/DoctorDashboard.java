...
public class DoctorDashboard extends AppCompatActivity {
    ...
    private void fetchAndDisplayUsername() {
        ...
        DocumentReference userRef = db.collection("doctors").document(userId);
        ...
        userRef.get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                if (document.exists()) {
                    ...
                    Toast.makeText(DoctorDashboard.this, "User data not found!", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(DoctorDashboard.this, "Failed to fetch user data: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setupButtons() {
        findViewById(R.id.btn_book_appointment).setOnClickListener(v -> {
            Intent intent = new Intent(DoctorDashboard.this, ViewAppointmentsActivity.class);
            startActivity(intent);
        });
        ...
        findViewById(R.id.btn_telemedicine).setOnClickListener(v -> {
            Intent intent = new Intent(DoctorDashboard.this, TelemedicineActivity.class);
            startActivity(intent);
        });
    }
